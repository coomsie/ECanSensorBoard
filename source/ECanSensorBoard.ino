...
SeeedOled.putString("Humidity: " + humidityDisplay.substring(0,humidityDisplay.lastIndexOf(".")+2) + "RH"); //Print the String
...
if ((millis()-starttime) > sampletime_ms)//if the sampel time == 30s
  ...
  else
  {
      ...
      humidity = (String) h;
      tempDHTC = (String) t;
      humidityDisplay = (String) (roundf((h* 100) / 100));
      tempDHTCDisplay = (String) (roundf((t* 100) / 100));

      ///display on the simple LCD
      dispNum((unsigned int) (t));
  }
